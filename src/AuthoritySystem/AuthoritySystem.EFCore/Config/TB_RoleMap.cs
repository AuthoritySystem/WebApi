...
{
    public class TB_RoleMap : IEntityTypeConfiguration<TB_Role>
    {
        public void Configure(EntityTypeBuilder<TB_Role> builder)
        {
            // 配置生成的表名
            ...
            builder.Property(p => p.RoleName).HasMaxLength(32).IsRequired().HasComment("角色名称");
        }
    }
}
